$(function() {
	...
	$('#don_I').css('background','#B0F2B6');
	$('#don_II').css('background','#B0F2B6');
	$('#don_III').css('background','#B0F2B6');
	$('#don_IV').css('background','#B0F2B6');
	$('#don_V').css('background','#B0F2B6');
	$('#don_VI').css('background','#B0F2B6');
	$('#don_VII').css('background','#B0F2B6');
	$('#don_VIII').css('background','#B0F2B6');
	$('#don_IX').css('background','#B0F2B6');
	$('#don_X').css('background','#B0F2B6');
	$('#don_XI').css('background','#B0F2B6');
	$('#don_XII').css('background','#B0F2B6');
	$('#don_XIII').css('background','#B0F2B6');
	$('#don_XIV').css('background','#B0F2B6');
	$('#don_XV').css('background','#B0F2B6');
	$('#don_XVI').css('background','#B0F2B6');
	$('#don_XVII').css('background','#B0F2B6');
	$('#don_XVIII').css('background','#B0F2B6');
	$('#don_XIX').css('background','#B0F2B6');
	$('#don_XX').css('background','#B0F2B6');
});
