...
$(function() {
    ...
    $('#race').change(function() {
        ...
        if ($('#race').val() == 'Nain') {
            ...
            // Stabilité. Les nains reçoivent un bonus racial de +4 à leur degré de manoeuvres défensives (DMD) lorsqu’ils se tiennent sur le sol et qu’ils tentent de résister à une bousculade ou à un croc-en-jambe.
